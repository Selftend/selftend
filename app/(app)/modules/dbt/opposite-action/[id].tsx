...
import DbtOppositeActionDetailScreen from "@/src/features/dbt/dbt-opposite-action-detail-screen";

export default function DbtOppositeActionDetailRoute() {
  ...
  return <DbtOppositeActionDetailScreen id={id} />;
}
