...
| `EXPO_PUBLIC_PLAY_STORE_URL`            | optional             | n/a                  | n/a                 | Play listing URL: store chip, Android download bar, and native update offer. Empty shows "Coming soon" and disables the bar and the native offer. Set in prod+staging environments and as a repo var for the Android build. |
