...
| CBT thought records    | `thought_records`                                     | Private user-owned records protected by RLS and included in export/delete.                                                        |
| Check-ins              | Planned dedicated records                             | Keep separate from CBT and journaling. Store only reviewed mood/check-in fields.                                                  |
| Journal entries        | Planned dedicated records                             | Keep free text separate from structured tool records. No social visibility in MVP.                                                |
