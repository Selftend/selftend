...
| ---------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `www` → apex redirect rule                     | Rules → Overview → the rule named "www to apex" (created via Create rule → Redirect Rule, "Custom filter expression")                                                                                                                                                                                                                                                                                                                                                         | expression `http.host eq "www.selftend.org"` - no path exceptions: the `/.well-known/` carve-out that spared the app-links association file was **retired 2026-09-24** ([#2298](https://github.com/Selftend/selftend/issues/2298)), once v0.21.0, which claims the apex only, was the current App Store version; redirect type **Dynamic**, expression `concat("https://selftend.org", http.request.uri)`; status **301**; leave "Preserve query string" off (the default) - the target already carries the query                                              | `curl -sI https://www.selftend.org/faq` → `301` with `location: https://selftend.org/faq`; `curl -sI "https://www.selftend.org/faq?x=1"` keeps `?x=1`; `curl -sI https://www.selftend.org/.well-known/apple-app-site-association` → `301` with `location: https://selftend.org/.well-known/apple-app-site-association` (it answered `200` until the carve-out came off). **Verified 2026-09-24** - all three pass; `http://www` 301s straight to the HTTPS apex in one hop                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
