...
| Always Use HTTPS                               | SSL/TLS → Edge Certificates → Always Use HTTPS                                                                                                                                                                                                                                                                                                                                                                                                                                | **on** (zone-wide: apex, `www`, `staging`). No HSTS preload submission - the `preload` token in `public/_headers` stays as it is ("HSTS preload" below)                                                                                                                                                                                                                                                                                                                                                                                                        | `curl -sI http://selftend.org/` → `301` with `location: https://selftend.org/`; `curl -sI http://staging.selftend.org/` → `301` to its HTTPS host. **Verified 2026-09-22** (⚠️ `staging` is still on this zone; it leaves on [#2319](https://github.com/Selftend/selftend/issues/2319), after which "zone-wide" here means apex and `www` only)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
