...
- [reminders.md](reminders.md) - the reminders spec (built, bar two cleanups and the release; the hold-out was lifted 2026-09-22): one general reminder, suggested by placement alone on the Reminders screen and the settings card, and every per-tool and routine reminder manual-only; the data model, the copy in both locales, and the numbered build list
