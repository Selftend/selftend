...
**Checked: 2026-09-04.** Every row below was read out of a national statute, a
national gazette, or a national data protection authority's own publication of
its statute. Consolidated mappings — the euConsent table and the Library of
Congress survey — are what is being checked here, so they are never the evidence
for a row.
...
| **NL** | 16            | `CONFIRMED` — basis corrected     | UAVG art. 5 applies only _"indien artikel 8 van de verordening **niet** van toepassing is"_ ⇒ default | [wetten.overheid.nl, current](https://wetten.overheid.nl/BWBR0040940/)                                                                                                                                     |
...
| **RO** | 16            | `CONFIRMED` — basis corrected     | Legea 190/2018 is **silent**; its art. 1 scope list omits GDPR Art. 8 ⇒ default                       | [ANSPDCP's hosted text](https://www.dataprotection.ro/servlet/ViewDocument?id=1520) — DPA-hosted, no consolidation stamp                                                                                   |
