...
**Status:** Canonical spec for the DBT module, assembled 2026-09-05 from wayfinder map [#1980](https://github.com/Selftend/selftend/issues/1980) - every decision below links to the ticket whose resolution comment holds its full reasoning. **The module is built.** The first-release slice named in §2 - the seven tools, the nine routes' worth of surfaces, the learn pages and the four-phase programme - shipped across [#2024](https://github.com/Selftend/selftend/issues/2024)-[#2033](https://github.com/Selftend/selftend/issues/2033) and has been in production since v0.18.0 (2026-09-09). The second slice (§3.5) and the post-MVP sections (§3.6) stay specified and unscheduled (§13). The companion design brief was `docs/design/1980-handoff/`; what it returned opened the implementation map that cut those tickets.
