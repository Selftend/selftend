...
6. In TestFlight, create the internal tester group and fill the test information. Then turn on **Enable automatic distribution** on that group, and builds land in it on arrival — EAS-uploaded builds included.
