...
Selftend is a set of free, private mental health tools - everyday tools for right now, yours to pick from at whatever pace suits you - run by the person using it. It should make support more available without becoming a paid trap, ad funnel, engagement game, diagnosis engine, or therapist replacement.
