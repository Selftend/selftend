...
**Cancelled 2026-09-11; it carries no recurring cost.** Paid on the owner's individual account from 2026-09-10. In the marketing plan's vocabulary it is an **instrument**, like Google Search Console - never a channel and never media spend - so Square 3's "no spend before the Bulgarian window reports" rule never touched it ([marketing-plan.md](marketing-plan.md) § 4, square 3; ruled on [#2289](https://github.com/Selftend/selftend/issues/2289)). It sat outside the Scenario A–C totals, and now contributes nothing to them.

- Status: **cancelled on 2026-09-11** ([#2308](https://github.com/Selftend/selftend/issues/2308)), one month after it was bought. **Exactly one charge was ever made**, `$29` on 2026-09-10. Verified on the billing plan row, which is the only trustworthy confirmation: end date `10 Oct 2026`, next billing date `—`.
- ⚠️ **Starter access runs to 2026-10-10**, the end of the period already paid for - cancelling early forfeited nothing. The workspace becomes free **Ahrefs Webmaster Tools** on that date. Reversible until then, via `Revert cancellation` on the billing page.
- What the `$29` bought: the demand facts behind the search-channel ruling (read 2026-09-10, seven of 200 credits), and the Site Audit that reads whether the site is readable to a crawler - nothing else. Free plus Search Console answers everything the indexability spec itself needs ([indexability.md](indexability.md) § 9).
- ☠️ **What Free retains, and what it does not.** Webmaster Tools keeps Site Explorer and Site Audit **for verified websites only** - `selftend.org` is verified, so the monthly audit survives the downgrade. Lost on 2026-10-10: Keywords Explorer, Content Explorer, Rank Tracker, Alerts, and Site Explorer or Site Audit for **unverified** websites, which is how competitor research was done. Any unverified project is frozen.
- Why it was not kept: Starter was bought for one read and one audit. A second month buys nothing any decision has asked for, and the acquisition-measurement work that might have justified it built no instrument at all ([#2304](https://github.com/Selftend/selftend/issues/2304), [map #2301](https://github.com/Selftend/selftend/issues/2301)). ⚠️ If the 2026-12-10 call promotes a pond that search serves, the question is a fresh subscription, not a lapsed one. **No reading buys a tier; a fresh month follows a promoted pond, never precedes the call** - the standings reading itself costs `$0` ([search-operations.md](search-operations.md) § 6; [#2425](https://github.com/Selftend/selftend/issues/2425)).
