-- Lightweight journaling: free-text private reflection entries, separate from
-- mood check-ins and CBT thought records. No reminders, no streaks, no required
-- structure. See docs/modules/journaling.md.
...
-- Extend account data export to include journal entries.
