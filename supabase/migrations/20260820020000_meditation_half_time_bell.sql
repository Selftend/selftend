...
-- pair is resolved into one BellChoice by src/features/timer/interval.ts.
--
...
-- preferences projection. Rebuilt from 20260820010000, the newest declaration
-- on dev, with ONLY that line added - verified by diff. Versioned
-- 20260820020000: full 14 digits, later than every existing version, sharing a
