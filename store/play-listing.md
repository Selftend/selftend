...
**Last verified against Play Console: 2026-09-22** — the full description lost the progress-view clause ([#2458](https://github.com/Selftend/selftend/issues/2458)), **submission 119**, sent 12:18, `In review`. The block below carries the new sentence; the public page keeps the old one until that row reads `Published`.

**The visit before it, 2026-09-20** — ☠️ **Visit A deleted both tablet screenshot tiers, sixteen images, and sent them for review.** That is the only change that visit made: the short description, the full description, the feature graphic and the promo video were opened, read and **left alone**. Why, and what the set now is, are in § _The screenshot set_ below.
...
And the two most recent visits, read off _Submission activity_ on **2026-09-22**:

| #       | Sent              | Change                                                                                                                                            | Status       |
| ------- | ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------- | ------------ |
| **119** | 2026-09-22, 12:18 | Store listing — full description, the progress-view clause removed ([#2458](https://github.com/Selftend/selftend/issues/2458))                    | In review    |
