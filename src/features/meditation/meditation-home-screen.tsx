...
export default function MeditationHomeScreen() {
  ...
  // for the latest completedAt rather than trusting order (breathing home
  // precedent).
  ...
  if (prefsLoading) {
    // The loading return takes the pour too, or the iris room drops out for as
    // long as preferences take to arrive (the grounding lesson, applied up front).
    return (
