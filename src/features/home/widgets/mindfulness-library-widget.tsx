      ...
      <CardContent className="gap-3 pt-4 pb-4">
        <View className="flex-row items-center gap-2">
          <View className="size-8 items-center justify-center rounded-lg bg-mist/10">
            <Icon name="format-list-bulleted" className="size-5 text-mist" />
          </View>
          <Text className="text-sm font-semibold">
            {t("home.widgets.mindfulnessLibrary.title")}
          </Text>
        </View>
        <Text variant="muted" className="text-xs">
          {t("home.widgets.mindfulnessLibrary.count", { count: mindfulnessExercises.length })}
        </Text>
        <Button
          size="sm"
          variant="ghost"
