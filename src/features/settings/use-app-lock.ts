...
/**
 * Biometric availability probe + auth-gated app-lock toggle, extracted verbatim
 * from `SecuritySection`. The `Platform.OS === "web"` early-return stays in the
 * component; this hook is always called (no conditional hooks).
 */
