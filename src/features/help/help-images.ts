...
export const HELP_IMAGES: Partial<Record<HelpKey, ImageSourcePropType>> = {
  ...
  expansion: require("../../../assets/images/help/expansion.png"),
  connection: require("../../../assets/images/help/connection.png"),
  observingSelf: require("../../../assets/images/help/observing_self.png"),
  committedAction: require("../../../assets/images/help/committed_action.png"),
};
