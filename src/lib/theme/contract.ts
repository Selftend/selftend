...
//
//   --accent-ink  Deleted. It was the room-poured hue ink, and outside a room
//                 it fell back to the app accent — the silent-violet trap #403
//                 spent a sweep on. Rooms went neutral (#558/#586), #589
//                 deleted the var, and #1292 deleted the room surface itself;
//                 test/theme-token-sync.test.ts pins the var's absence.
//
