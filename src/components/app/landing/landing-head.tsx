 ...
 * layout's `SiteHead` renders as `<html lang>` (§ 4.4; brand-result.md § 6,
 * #2468). A JSON-LD script is a data block: the CSP's inline-script hashes
 * never apply to it.
 */
  ...
  return (
    <Head>
      ...
      <script type={STRUCTURED_DATA_TYPE}>
        {JSON.stringify(landingStructuredData({ url, description, language: i18n.language }))}
      </script>
    </Head>
  );
}
