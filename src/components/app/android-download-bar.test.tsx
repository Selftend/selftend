...
describe("AndroidDownloadBar", () => {
  ...
  // ☠️ Nothing else in this file presses the action, so without this the bar
  // could be reverted to the bare `appEnv.playStoreUrl` and the suite would
  // stay green. Play reads its parameters only out of a URL-encoded
  // `referrer=`, so the nesting is what is asserted (#2324, measurement.md § 5).
